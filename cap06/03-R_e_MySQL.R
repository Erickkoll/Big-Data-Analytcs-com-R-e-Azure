...
setwd("C:/Users/erick/OneDrive/Área de Trabalho/Programação/Big Data Analytcs com R e Azure/cap06")
getwd()
...
?dbConnect
con = dbConnect(MySQL(), user = "root", password = "ml2023", dbname = "titanicDB", host = "localhost")
...
?src_mysql
con2 <- dbConnect(MySQL(),dbname = "titanicdb", user = "root", password = "ml2023", host = "localhost")
